  ...
  */
  uploadCourseMaterials: wrapAsync(async (req, res, next) => {
    ...
    async postCourse(req, res, next) {
      const {teacher_id, category_id, course_name, course_banner_imageUrl, course_banner_description, course_description, course_description_image, course_smallimage, course_hours, total_users, trailer_vimeo_id, trailer_name, trailer_url, trailer_status, handout_name, handout_url, suitable_for, course_goal, origin_price, sell_price, course_status} = req.body;
